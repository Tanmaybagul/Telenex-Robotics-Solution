...
bool custom_interfaces__msg__object_meta_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._object_meta_data.ObjectMetaData", full_classname_dest, 54) == 0);
  }
  custom_interfaces__msg__ObjectMetaData * ros_message = _ros_message;
  {  // object_id
...
{
  /* NOTE(esteve): Call constructor of ObjectMetaData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._object_meta_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectMetaData");
